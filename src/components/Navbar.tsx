...
const Navbar = () => {
  ...
  // وضعنا رابط اللوجو الأبيض كقيمة افتراضية هنا
  const [siteLogo, setSiteLogo] = useState('https://yibbovtecpbxlntfmvwd.supabase.co/storage/v1/object/public/avatars/site/logo_1774696212634.png');
